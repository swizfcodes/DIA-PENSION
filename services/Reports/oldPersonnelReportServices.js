...
class OldPersonnelReportService {
    ...
    try {
      const query = `
        SELECT 
          ...
          -- Calculate Years of Service (from employment to exit date)
          CASE 
            WHEN h.DateEmpl IS NOT NULL AND h.DateEmpl != '' AND LENGTH(h.DateEmpl) = 8
              AND h.DateLeft IS NOT NULL AND h.DateLeft != '' AND LENGTH(h.DateLeft) = 8
            THEN TIMESTAMPDIFF(YEAR, 
    ...
    try {
      const query = `
        SELECT 
          ...
          COUNT(DISTINCT h.exittype) as total_exit_types,
  ...
  // ========================================================================
  // GET FILTER OPTIONS - Titles/Ranks (OLD EMPLOYEES)
  // ========================================================================
  ...
  // ========================================================================
  // GET FILTER OPTIONS - PFAs (OLD EMPLOYEES)
  // ========================================================================
    ...
    try {
      ...
      const query = `
        ...
        WHERE pfacode IS NOT NULL AND pfacode != ''
          AND payrollclass = ?
          AND ((LENGTH(IFNULL(DateLeft, '')) > 0 AND STR_TO_DATE(DateLeft, '%Y%m%d') <= CURDATE()) 
  ...
  // ========================================================================
  // GET FILTER OPTIONS - Locations (OLD EMPLOYEES)
  // ========================================================================
  ...
  // ========================================================================
  // GET FILTER OPTIONS - Grade Types (OLD EMPLOYEES)
  // ========================================================================
  ...
  // ========================================================================
  // GET FILTER OPTIONS - Grade Levels (OLD EMPLOYEES)
  // ========================================================================
  ...
  // ========================================================================
  // GET FILTER OPTIONS - Bank Branches (OLD EMPLOYEES)
  // ========================================================================
  ...
  // ========================================================================
  // GET FILTER OPTIONS - States of Origin (OLD EMPLOYEES)
  // ========================================================================
  ...
  // ========================================================================
  // GET FILTER OPTIONS - Rent Subsidy (OLD EMPLOYEES)
  // ========================================================================
  ...
  // ========================================================================
  // GET FILTER OPTIONS - Taxed Status (OLD EMPLOYEES)
  // ========================================================================
